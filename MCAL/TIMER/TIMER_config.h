...
#define TIMER0_OC0_OUTPUT_STATE			TIMER0_OC0_OUTPUT_ENABLE
		...
		#define TIMER_OC0_OUTPUT_MODE			TIMER_CLR_OC0
	#endif
#endif
 ...
 * - TIMER1_MODE_FastPWM_16bit_FREQ
 *
 * [[ Phase Correct ]]
 ...
 *
 */
#define TIMER1_MODE_SELECT				 TIMER1_MODE_FastPWM_16bit_FREQ
...
#define TIMER1_OC1B_OUTPUT_STATE		TIMER1_OC1_OUTPUT_ENABLE
	...
	TIMER1_MODE_SELECT == TIMER1_MODE_FastPWM_16bit_FREQ|| \
	TIMER1_MODE_SELECT == TIMER1_MODE_PWMphasecorrect_16bit_FREQ)
	...
	// Options:
	//	- TIMER_FastPwmType_Inverted,
	//	- TIMER_FastPwmType_NonInverted,
	...
	// Options:
	//	- TIMER_PhaseCorrect_Inverted
	//  - TIMER_PhaseCorrect_NonInverted
...
// Options: TIMER_MODE_NORMALovf	or		TIMER_MODE_PWMphasecorrect
//			TIMER_MODE_FastPWM      or  	TIMER_MODE_CTC
#define TIMER2_MODE_SELECT				TIMER_MODE_FastPWM
